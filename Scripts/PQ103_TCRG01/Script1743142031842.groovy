...
"Create new Reservation for normal Guest"

//get data from excel sheet
def customerdata = CustomKeywords.'com.Parkquility.app.common.CommonKeywords.getTestDataFromFile'('Customerdata', 'CG1')
def updatedCustomerData = CustomKeywords.'com.Parkquility.app.common.CommonKeywords.getTestDataFromFile'('Customerdata', 'CG11')
def paymentData = CustomKeywords.'com.Parkquility.app.common.CommonKeywords.getTestDataFromFile'('PaymentData', 'P2')
...
//CustomKeywords.'com.Parkquility.app.Keywords.ReservationPage.verifyMakeVisitorFeature'(updatedCustomerData, "Car Requested","Guest")
